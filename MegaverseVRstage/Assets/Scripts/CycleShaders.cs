...
public class CycleShaders : MonoBehaviour {
	...
	void Start () {
        ...
        _nextOptionIndex = 0;
        gameObject.GetComponent<Renderer>().material.shader = options[_nextOptionIndex];
	...
	void Update () {
		...
		if(Input.GetKeyDown(keyboardKey))
		{
            ...
            gameObject.GetComponent<Renderer>().material.shader = options[_nextOptionIndex]; // _nextOption;
